...
export default function Header() {
    ...
    return (
        <div data-ref="header"className="flex w-screen bg-slate-800 h-20">
            <img src="./images/Podd_Logo.png" className="h-3/4 mt-auto mb-auto ml-12"/>
            ...
            <div className="relative h-1/2 ml-auto mr-5 mt-auto mb-auto ">
                ...
                <img data-ref="search-button" src="./images/magnifying_glass.png" className="h-6 w-6 absolute top-1/2 right-2 -translate-y-1/2 hover:cursor-pointer"/>
            </div>  
        </div>
    )
}